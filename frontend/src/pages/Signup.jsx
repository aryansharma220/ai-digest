      ...
      {darkMode && (
        <div className="absolute inset-0 overflow-hidden">
          ...
          {Array.from({ length: 15 }).map((_, i) => (
            <div 
              key={i}
              className="absolute rounded-full bg-gradient-to-r from-indigo-500/5 to-purple-500/5 animate-floatingSlow"
              style={{
                top: `${Math.random() * 100}%`,
                left: `${Math.random() * 100}%`,
      ...
      <div className="relative max-w-md w-full animate-fadeIn">
        ...
        <div className={`${
          ...
          <p className={`text-center mb-8 ${
            ...
            Join our community of AI enthusiasts and stay updated
          </p>
        ...
        <div className={`text-center mt-8 text-sm animate-fadeIn animation-delay-300 ${
          ...
          <p>By signing up, you agree to our <a href="#" className="text-indigo-600 hover:text-indigo-500">Terms of Service</a> and <a href="#" className="text-indigo-600 hover:text-indigo-500">Privacy Policy</a></p>
        </div>
      </div>
